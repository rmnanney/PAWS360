...
docker run -d \
  ...
  -v ./database/enhanced_demo_seed_data.sql:/docker-entrypoint-initdb.d/01-seed.sql:ro \
      -d '{"email":"john.smith@uwm.edu","password":"<DEMO_PASSWORD>"}'
...
- [Task Implementation Summary](docs/portfolio/T055-IMPLEMENTATION-SUMMARY.md)
- [Performance Testing Results](docs/portfolio/T058-PERFORMANCE-COMPLETION-REPORT.md)
- [Security Testing Results](docs/portfolio/T059-SECURITY-COMPLETION-REPORT.md)
