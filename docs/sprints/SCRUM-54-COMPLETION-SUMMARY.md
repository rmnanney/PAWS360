...
- `docs/ci-cd/CI-CD-README.md` - CI/CD documentation
- `scripts/testing/local/test-local-ci-cd.sh` - Local testing script
...
### Documentation
- `docs/testing/TEST_STATUS.md` - Test analysis and recommendations
- `docs/sprints/SPRINT-STATUS.md` - Sprint summary
- `docs/project/planning/NEXT-STEPS-INFRASTRUCTURE-TRACK.md` - Roadmap
- `docs/sprints/SCRUM-79-User-Story.md` - Next story (AdminLTE implementation)
- `docs/sprints/SCRUM-79-gpt-context.md` - Complete TDD guide for SCRUM-79
...
# See docs/sprints/SCRUM-80-User-Story.md for details
...
cat docs/sprints/SCRUM-79-gpt-context.md
...
💡 **Test Scope Mismatch** - Identified that tests expect full app, documented in docs/testing/TEST_STATUS.md  
...
3. **Document decisions** - Future agents need context (like docs/sprints/SCRUM-79-gpt-context.md)
...
### Documentation
- `docs/sprints/SCRUM-54-User-Story.md` - This story's requirements
- `docs/sprints/SCRUM-80-User-Story.md` - Next story (compilation fixes)
- `docs/sprints/SCRUM-79-User-Story.md` - UI implementation story
- `docs/sprints/SCRUM-79-gpt-context.md` - **Complete TDD guide for future work**
- `docs/project/planning/NEXT-STEPS-INFRASTRUCTURE-TRACK.md` - Detailed roadmap
