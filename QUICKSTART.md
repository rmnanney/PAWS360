...
If you prefer step-by-step instructions, see **[SETUP_FROM_SCRATCH.md](SETUP_FROM_SCRATCH.md)**
...
- **Complete Setup Guide**: [SETUP_FROM_SCRATCH.md](SETUP_FROM_SCRATCH.md)
...
**Questions?** Check [SETUP_FROM_SCRATCH.md](SETUP_FROM_SCRATCH.md) for detailed troubleshooting.
