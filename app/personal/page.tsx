...
import { User, Mail, Phone, MapPin, Shield, Edit, Save, Eye, EyeOff, AlertTriangle } from "lucide-react";
				...
				<div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{contactInfo.email.split('@')[0]}</div>
								<p className="text-xs text-muted-foreground">
									@uwm.edu
								</p>
							</CardContent>
								...
								<CardContent className="space-y-6">
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
										<div className="space-y-4">
											<div>
												...
												<p className="text-lg font-semibold">{personalInfo.studentId}</p>
											</div>
											<div>
									...
									<div className="border-t pt-4">
										...
										<p className="text-xs text-muted-foreground mt-1">
											This information is protected under FERPA and only visible to you.
										</p>
									</div>
								</CardContent>
							</Card>
										...
										<div>
											...
											<div className="flex items-start space-x-3">
												...
												<div className="text-sm">
													...
													<p>{contactInfo.permanentAddress.city}, {contactInfo.permanentAddress.state} {contactInfo.permanentAddress.zipCode}</p>
									...
									<CardContent className="space-y-4">
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-sm text-muted-foreground">Allow basic info in student directory</p>
											</div>
											<Badge className={privacySettings.ferpaDirectory ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-sm text-muted-foreground">Allow use of photos in publications</p>
											</div>
											<Badge className={privacySettings.photoRelease ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-sm text-muted-foreground">Overall privacy setting</p>
											</div>
											<Badge className={getPrivacyLevelColor(privacySettings.infoRelease)}>
									...
									<CardContent className="space-y-4">
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-sm text-muted-foreground">Allow phone communications</p>
											</div>
											<Badge className={privacySettings.contactByPhone ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
										...
										<div className="flex items-center justify-between">
											...
											<Badge className={privacySettings.contactByEmail ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
										...
										<div className="flex items-center justify-between">
											<div>
												...
												<p className="text-sm text-muted-foreground">Allow postal mail communications</p>
											</div>
											<Badge className={privacySettings.contactByMail ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
								...
								<CardContent>
									<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
										<div className="text-center">
											...
											<Badge className={`${getStatusColor(securityInfo.accountStatus)} mt-1`}>
										...
										<div className="text-center">
											...
											<Badge className={`${securityInfo.twoFactorEnabled ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'} mt-1`}>
										...
										<div className="text-center">
											...
											<Badge className={`${securityInfo.securityQuestions ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'} mt-1`}>
