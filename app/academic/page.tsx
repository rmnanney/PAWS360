...
const transcriptData = [
	...
	},
	{
		term: "Spring 2025",
		courses: [
			{ course: "CS 250", title: "Intro to Computer Science", grade: "A", credits: 3 },
	...
	},
	{
		term: "Fall 2024",
		courses: [
			{ course: "CS 150", title: "Programming Fundamentals", grade: "A", credits: 3 },
			{ course: "MATH 208", title: "Discrete Mathematics", grade: "B+", credits: 4 },
				...
				<div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{academicStats.cumulativeGPA}</div>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold text-green-600">Good Standing</div>
								<p className="text-xs text-muted-foreground">
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">{academicStats.graduationProgress}%</div>
								<Progress value={academicStats.graduationProgress} className="mt-2" />
												...
												<div className="flex items-center space-x-4">
													...
													<div>
														...
														<p className="text-sm text-muted-foreground">
															{course.credits} credits • Last updated: {course.lastUpdated}
														</p>
													</div>
												</div>
												<div className="flex items-center space-x-4">
											...
											<div key={termIndex} className="border rounded-lg p-4">
												<div className="flex items-center justify-between mb-4">
													...
													<div className="text-right">
														...
														<p className="text-sm text-muted-foreground">{term.credits} credits</p>
													</div>
												</div>
												<div className="space-y-2">
													{term.courses.map((course, courseIndex) => (
														<div key={courseIndex} className="flex items-center justify-between py-2 border-b last:border-b-0">
															<div>
																<p className="font-medium">{course.course}: {course.title}</p>
															</div>
															<div className="flex items-center space-x-4">
																<Badge className={getGradeColor(course.grade)}>
																	{course.grade}
															...
															<div className="flex items-center text-sm">
																{term.gpa > transcriptData[index - 1].gpa ? (
																	<>
																		...
																		<span className="text-green-600">+{(term.gpa - transcriptData[index - 1].gpa).toFixed(2)}</span>
																	</>
																) : term.gpa < transcriptData[index - 1].gpa ? (
																	<>
																		<TrendingDown className="h-4 w-4 text-red-600 mr-1" />
																		<span className="text-red-600">{(term.gpa - transcriptData[index - 1].gpa).toFixed(2)}</span>
																	</>
																) : (
