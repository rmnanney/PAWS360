      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Campus libraries available</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Subjects and services</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Workshops and events</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="libraries" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Access books, journals, study spaces, and research help</CardDescription>
            </CardHeader>
            <CardContent>
              <PaginatedTable
        ...
        <TabsContent value="tutoring" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Get help with coursework, writing, and academic skills</CardDescription>
            </CardHeader>
            <CardContent>
              <PaginatedTable
        ...
        <TabsContent value="services" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Health, wellness, career, and support services available to students</CardDescription>
            </CardHeader>
            <CardContent>
              <PaginatedTable
        ...
        <TabsContent value="study" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Find quiet places to study, meet with groups, or work on assignments</CardDescription>
            </CardHeader>
            <CardContent>
              <PaginatedTable
        ...
        <TabsContent value="events" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Workshops, talks, and other campus events</CardDescription>
            </CardHeader>
            <CardContent>
              <PaginatedTable
