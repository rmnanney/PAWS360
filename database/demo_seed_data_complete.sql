-- Demo Data for PAWS360 - Complete Version
-- This script inserts demo users and students for testing SSO authentication

BEGIN;

-- Insert demo admin user (all required fields)
...
('Admin', 'User', '1980-01-01', '123456789', 'admin@uwm.edu', 
 ...
 'RESTRICTED', true, true, false, false, false, CURRENT_DATE);
...
INSERT INTO student (user_id, campus_id, department, standing, enrollement_status, gpa, expected_graduation, created_at, updated_at)
SELECT u.user_id,
       CASE 
       ...
       CASE 
           ...
           WHEN u.email = 'sarah.wilson@uwm.edu' THEN 'MATHEMATICAL_SCIENCES'
