...
show_help() {
    ...
    echo "  Admin:    admin@uwm.edu / password"
    echo "  Student:  john.smith@uwm.edu / password"
    echo "  Student:  demo.student@uwm.edu / password"
    echo ""
    echo "Service URLs:"
...
show_demo_info() {
    ...
    echo -e "  👨‍💼 Administrator: ${YELLOW}admin@uwm.edu${NC} / ${YELLOW}password${NC}"
    echo -e "  🎓 Primary Student: ${YELLOW}john.smith@uwm.edu${NC} / ${YELLOW}password${NC}"
    echo -e "  🎓 Demo Student: ${YELLOW}demo.student@uwm.edu${NC} / ${YELLOW}password${NC}"
    echo -e "  👩‍🎓 Test Student: ${YELLOW}emily.johnson@uwm.edu${NC} / ${YELLOW}password${NC}"
    echo ""
