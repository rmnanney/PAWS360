...
SELECT 'Demo', 'Student', '1990-01-01', '123456789', 'demo.student@uwm.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj8ZJcKvqXu', 'ACTIVE', 'student', 'RESTRICTED', TRUE, TRUE, FALSE, FALSE, FALSE, 0, FALSE
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'demo.student@uwm.edu');

INSERT INTO users (firstname, lastname, dob, ssn, email, password, status, role, ferpa_compliance, contact_by_phone, contact_by_email, contact_by_mail, ferpa_directory_opt_in, photo_release_opt_in, failed_attempts, account_locked)
SELECT 'Demo', 'Admin', '1980-01-01', '987654321', 'demo.admin@uwm.edu', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj8ZJcKvqXu', 'ACTIVE', 'admin', 'RESTRICTED', TRUE, TRUE, FALSE, FALSE, FALSE, 0, FALSE
