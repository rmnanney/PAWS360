...
class AddressTest {
    ...
    void testParameterizedConstructor() {
        // Given
        Users user = new Users(); // Mock user for testing
        ...
        // When
        Address address = new Address(user, addressType, firstname, lastname,
                                     streetAddress1, streetAddress2, poBox, city, state, zipcode);
