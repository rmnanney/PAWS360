...
- [X] CHK203 - Are documentation update requirements specified? [docs/onboarding/developer-onboarding.md workflow, docs/ structure maintained in sync with changes]
