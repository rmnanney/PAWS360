...
echo "   SSO tests are retired by default. To run legacy SSO tests (not recommended) set RETIRE_SSO=false and run:"
echo "   cd tests/ui && RETIRE_SSO=false npx playwright test sso-authentication.spec.ts"
echo ""
...
echo "   Tests: UI User journeys (SSO tests retired)"
