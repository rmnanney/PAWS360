...
- `SPRING_DATASOURCE_PASSWORD=paws360_dev_password`
...
docker start paws360-postgres || docker run -d --name paws360-postgres -e POSTGRES_DB=paws360_dev -e POSTGRES_USER=paws360 -e POSTGRES_PASSWORD=paws360_dev_password -p 5432:5432 postgres:15-alpine
